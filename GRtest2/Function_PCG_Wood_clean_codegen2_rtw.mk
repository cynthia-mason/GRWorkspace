...
MODEL                = Function_PCG_Wood_clean_codegen2
MODULES              = Function_PCG_Wood_clean_codegen2_initialize.c Function_PCG_Wood_clean_codegen2_terminate.c Function_PCG_Wood_clean_codegen2.c sum.c mrdivide.c rdivide.c colon.c abs.c diag.c eye.c cond.c Function_PCG_Wood_clean_codegen2_emxutil.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = Function_PCG_Wood_clean_codegen2_rtw.mk
...
MODELLIB                  = Function_PCG_Wood_clean_codegen2.dll
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Function_PCG_Wood_clean_codegen2_ref.rsp
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = C:\Users\cmason01\DOCUME~1\CYNTHI~1\MARCH3~1\IPMFOR~2
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\cmason01\DOCUME~1\CYNTHI~1\MARCH3~1\IPMFOR~2
