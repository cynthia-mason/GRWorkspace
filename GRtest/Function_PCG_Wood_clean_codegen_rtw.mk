...
MODEL                = Function_PCG_Wood_clean_codegen
MODULES              = Function_PCG_Wood_clean_codegen_initialize.c Function_PCG_Wood_clean_codegen_terminate.c Function_PCG_Wood_clean_codegen.c sum.c mrdivide.c rdivide.c colon.c abs.c diag.c eye.c cond.c Function_PCG_Wood_clean_codegen_emxutil.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = Function_PCG_Wood_clean_codegen_rtw.mk
...
MODELLIB                  = Function_PCG_Wood_clean_codegen.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Function_PCG_Wood_clean_codegen_ref.rsp
MODELREF_INC_PATH         = 
