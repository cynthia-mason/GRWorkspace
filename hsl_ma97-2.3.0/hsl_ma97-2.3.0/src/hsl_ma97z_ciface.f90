module hsl_ma97_double_complex_ciface
   use iso_c_binding
   use hsl_ma97_double_complex, only:                    &
   ...
   integer, parameter :: wp = C_DOUBLE_COMPLEX ! pkg type
...
end module hsl_ma97_double_complex_ciface

subroutine ma97_default_control_z(ccontrol) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
...
end subroutine ma97_default_control_z

subroutine ma97_analyse_z(ccheck, n, cptr, crow, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
   ...
   complex(wp), dimension(:), pointer :: fval
...
end subroutine ma97_analyse_z

subroutine ma97_analyse_coord_z(n, ne, crow, ccol, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
...
end subroutine ma97_analyse_coord_z

subroutine ma97_factor_z(matrix_type, cptr, crow, cval, cakeep, cfkeep, &
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_factor_z

subroutine ma97_factor_solve_z(matrix_type, cptr, crow, cval, nrhs, cx, ldx, &
   ...
   integer, dimension(:), allocatable, target :: frow_alloc
   complex(wp), dimension(:), pointer :: fval
   complex(wp), dimension(:,:), pointer :: fx
   type(f_ma97_akeep), pointer :: fakeep
   type(f_ma97_fkeep), pointer :: ffkeep
   type(f_ma97_control) :: fcontrol
   type(f_ma97_info) :: finfo
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_factor_solve_z

subroutine ma97_solve_z(job, nrhs, cx, ldx, cakeep, cfkeep, ccontrol, cinfo) &
      bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_solve_z

subroutine ma97_free_akeep_z(cakeep) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
...
end subroutine ma97_free_akeep_z

subroutine ma97_free_fkeep_z(cfkeep) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
...
end subroutine ma97_free_fkeep_z

subroutine ma97_finalise_z(cakeep, cfkeep) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
   ...
   call ma97_free_akeep_z(cakeep)
   call ma97_free_fkeep_z(cfkeep)
end subroutine ma97_finalise_z

subroutine ma97_enquire_posdef_z(cakeep, cfkeep, ccontrol, cinfo, cd) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_enquire_posdef_z

subroutine ma97_enquire_indef_z(cakeep, cfkeep, ccontrol, cinfo, cpiv_order, &
      cd) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
   ...
   type(f_ma97_control) :: fcontrol
   type(f_ma97_info) :: finfo
   complex(wp), dimension(:,:), pointer :: fd
...
end subroutine ma97_enquire_indef_z

subroutine ma97_alter_z(cd, cakeep, cfkeep, ccontrol, cinfo) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_alter_z

subroutine ma97_solve_fredholm_z(nrhs, cflag_out, cx, ldx, cakeep, cfkeep, &
...
end subroutine ma97_solve_fredholm_z

subroutine ma97_lmultiply_z(ctrans, k, cx, ldx, cy, ldy, cakeep, cfkeep, &
      ccontrol, cinfo) bind(C)
   use hsl_ma97_double_complex_ciface
   implicit none
   ...
   logical :: ftrans
   complex(wp), dimension(:,:), pointer :: fx
   complex(wp), dimension(:,:), pointer :: fy
   type(f_ma97_akeep), pointer :: fakeep
   type(f_ma97_fkeep), pointer :: ffkeep
   type(f_ma97_control) :: fcontrol
   type(f_ma97_info) :: finfo
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_lmultiply_z

subroutine ma97_sparse_fwd_solve_z(nbi, cbindex, cb, corder, cnxi, &
   ...
   complex(wp), dimension(:), pointer :: fb
   integer(C_INT), dimension(:), pointer :: forder
...
end subroutine ma97_sparse_fwd_solve_z
