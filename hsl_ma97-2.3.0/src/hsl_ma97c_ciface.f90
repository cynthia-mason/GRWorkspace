module hsl_ma97_complex_ciface
   use iso_c_binding
   use hsl_ma97_complex, only:              &
   ...
   integer, parameter :: wp = C_FLOAT_COMPLEX ! pkg type
...
end module hsl_ma97_complex_ciface

subroutine ma97_default_control_c(ccontrol) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
...
end subroutine ma97_default_control_c

subroutine ma97_analyse_c(ccheck, n, cptr, crow, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
...
end subroutine ma97_analyse_c

subroutine ma97_analyse_coord_c(n, ne, crow, ccol, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
...
end subroutine ma97_analyse_coord_c

subroutine ma97_factor_c(matrix_type, cptr, crow, cval, cakeep, cfkeep, &
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_factor_c

subroutine ma97_factor_solve_c(matrix_type, cptr, crow, cval, nrhs, cx, ldx, &
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_factor_solve_c

subroutine ma97_solve_c(job, nrhs, cx, ldx, cakeep, cfkeep, ccontrol, cinfo) &
      bind(C)
   use hsl_ma97_complex_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_solve_c

subroutine ma97_free_akeep_c(cakeep) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
...
end subroutine ma97_free_akeep_c

subroutine ma97_free_fkeep_c(cfkeep) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
...
end subroutine ma97_free_fkeep_c

subroutine ma97_finalise_c(cakeep, cfkeep) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
   ...
   call ma97_free_akeep_c(cakeep)
   call ma97_free_fkeep_c(cfkeep)
end subroutine ma97_finalise_c

subroutine ma97_enquire_posdef_c(cakeep, cfkeep, ccontrol, cinfo, cd) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_enquire_posdef_c

subroutine ma97_enquire_indef_c(cakeep, cfkeep, ccontrol, cinfo, cpiv_order, &
      cd) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
...
end subroutine ma97_enquire_indef_c

subroutine ma97_alter_c(cd, cakeep, cfkeep, ccontrol, cinfo) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_alter_c

subroutine ma97_solve_fredholm_c(nrhs, cflag_out, cx, ldx, cakeep, cfkeep, &
...
end subroutine ma97_solve_fredholm_c

subroutine ma97_lmultiply_c(ctrans, k, cx, ldx, cy, ldy, cakeep, cfkeep, &
      ccontrol, cinfo) bind(C)
   use hsl_ma97_complex_ciface
   implicit none
   ...
   ! Copy information out to the C structure
   call copy_info_out(finfo, cinfo)
end subroutine ma97_lmultiply_c

subroutine ma97_sparse_fwd_solve_c(nbi, cbindex, cb, corder, cnxi, &
...
end subroutine ma97_sparse_fwd_solve_c
